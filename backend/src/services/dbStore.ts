...
class DBStore {
  ...
  public seedDefaults() {
    ...
    const userDigiryte: User = {
      id: 'usr_digiryte_user',
      email: 'user@digiryte.com',
      passwordHash,
      name: 'Digiryte Standard User',
      role: 'USER',
      createdAt: new Date().toISOString(),
    };

    const adminDigiryte: User = {
      id: 'usr_digiryte_admin',
      email: 'admin@digiryte.com',
      passwordHash,
      name: 'Digiryte Admin',
      role: 'ADMIN',
      createdAt: new Date().toISOString(),
    ...
    this.users.set(userDigiryte.id, userDigiryte);
    this.users.set(adminDigiryte.id, adminDigiryte);
