...
import { checkAccountLockout, sensitiveRateLimiter } from '../../middleware/rateLimiter';
...
router.post('/login', sensitiveRateLimiter, checkAccountLockout, validateRequest(loginSchema), AuthController.login);
